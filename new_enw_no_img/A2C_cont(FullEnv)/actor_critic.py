...
class ActorCritic():
    def __init__(self, input_dim, allias_state, enemy_state, n_actions,\
...
class Actor(nn.Module):
    def __init__(self, allias_state, enemy_state,\
                 n_actions, max_actions, input_conv_dims = 15, lr = 0.01):
...
class Critic(nn.Module):
    def __init__(self, allias_state, enemy_state, input_conv_dims = 15, lr = 0.001):
