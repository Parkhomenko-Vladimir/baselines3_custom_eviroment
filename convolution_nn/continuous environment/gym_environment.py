...
class CustomEnv(gym.Env):
    ...
    def __init__(self, obstacle_turn: bool, vizualaze=False, Total_war=False):
        ...
        self.action_space = spaces.Box(low=np.array([15, -3.14]), high=np.array([50, 3.14]), dtype=np.float16)
    ...
    def step(self, action):
        ...
        :param action: ([float,float]) действие в среде [линейная скорость, угловая скорость]
